...
<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-2 col-lg-6 col-lg-offset-3 form">
    <a class="btn btn-success pull-right btn-sm" href="./index.php?page=newevaluation&mod=Admin"><i class="glyphicon glyphicon-plus"></i> Add evaluation</a>
    ...
    //print_r($records);
			...
			<tr>
				...
				<td>
                                    <a class="btn btn-xs btn-info" href="/Project/super/index.php?page=viewres&mod=Admin&evaluation=<?= htmlspecialchars($record['id']) ?>">
						View result
					</a>
				</td>
			</tr>
