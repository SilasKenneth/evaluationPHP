...
if(isset($_GET['evaluation'])){
    ...
    if(trim($ev)==''){
       ...
       $evaluations = HOD::getDepartmentResults($dept, $ev);
       if(!$evaluations){
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a  class="btn btn-success btn-xs"href="/Project/super/index.php?page=recommend&mod=Hod&lecturer=<?= $evaluation['lec'] ?>&unit=<?= $evaluation['unit'] ?>&evaluation=<?= $evaluation['evaluation']?>">Recommend</a>
                </td>
            </tr>
            <?php
                  }
