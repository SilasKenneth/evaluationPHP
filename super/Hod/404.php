...
<a href="/Project/super/index.php?page=lecs&mod=Hod" class="btn btn-info" align="center">Go Back</a>
<?php } else { ?>
<a href="/Project/super/index.php?page=login&mod=Hod" class="btn btn-info" align="center">Login</a>
<?php } ?>
</div>
<style>
  .error-title{
