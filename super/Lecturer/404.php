...
<a href="/Project/super/index.php?page=todayclasses&mod=Lecturer" class="btn btn-info" align="center">Go Back</a>
<?php } else { ?>
<a href="/Project/super/index.php?page=login&mod=Lecturer" class="btn btn-info" align="center">Login</a>
<?php } ?>
</div>
<style>
  .error-title{
